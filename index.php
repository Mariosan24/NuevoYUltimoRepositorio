...
case "checkoutcnl":
    ...
    die();
    case "info":
      require_once("controllers/info.control.php");
      die();
    case "consultas":
      include_once "controllers/consultas.control.php";
      die();
      case "citologia":
        require_once("controllers/cit.control.php");
        die();
        case "histerectomia":
        require_once("controllers/histerectomia.control.php");
        die();
        case "enfermedades":
        require_once("controllers/enfermedades.control.php");
        die();
        case "parto":
        require_once("controllers/parto.control.php");
        die();
        case "levantamiento":
        require_once("controllers/levant.control.php");
        die();
        case "ultra":
        require_once("controllers/ultra.control.php");
        die();
      case "register":
